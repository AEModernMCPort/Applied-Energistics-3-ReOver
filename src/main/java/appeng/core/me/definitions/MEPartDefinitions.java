...
public class MEPartDefinitions<P extends Part<P, S>, S extends Part.State<P, S>> extends Definitions<P, IPartDefinition<P, S>> implements IMEPartDefinitions<P, S> {
	...
	public MEPartDefinitions(DefinitionFactory registry){
		glassCableMicroGreen = registry.<P, IPartDefinition<P, S>, IPartBuilder<P, S, ?>, P>definitionBuilder(new ResourceLocation(AppEng.MODID, "glass_cable_micro_green"), ih(new PartDummy(false))).rootMesh(new ResourceLocation(AppEng.MODID, "cable/glass/micro/green.obj")).createDefaultPlacerItem().build();
		glassCableNormalGreen = registry.<P, IPartDefinition<P, S>, IPartBuilder<P, S, ?>, P>definitionBuilder(new ResourceLocation(AppEng.MODID, "glass_cable_normal_green"), ih(new PartDummy(true))).rootMesh(new ResourceLocation(AppEng.MODID, "cable/glass/normal/green.obj")).createDefaultPlacerItem().build();
